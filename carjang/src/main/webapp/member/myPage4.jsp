...
<body text="black" link="black" vlink="black" alink="black">
	...
	<div id="container">
		<div id="left">
			...
			<div class="leftMenu">
				<a href="#" style="text-decoration: none">예약 확인/결제</a></div>
			<div class="leftMenu">
				<a href="#" style="text-decoration: none">운전자 정보</a></div>
		</div>
		<div id="middle">></div>
		<div id="right">
			<div id="driverBox">
				...
				<div id="driverContent">
					...
					<label class="lblDrvier">운전면허번호</label>
						<input type="text" class="frmDriver" id="licenseNum" value="${driver.drv_lisc }"/>
						<input type="button" id="btnLicense"><br>
					<label class="lblDrvier">휴대폰 번호</label>
						<input type="text" class="frmDriver" id="mobileNum" value="${driver.drv_phone }"/><br>
					<label class="lblDrvier">보유차량</label>
						<input type="text" class="frmDriver" id="car"/>
						<input type="button" id="btnCarAdd1"><br>
					<label class="lblDrvier">차량번호</label>
						<input type="text" class="frmDriver" id="carNum"/>
					<label class="lblDrvier">차종</label>
						<input type="text" class="frmDriver" id="carNum"/>
